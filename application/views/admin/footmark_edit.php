                ...
                <div class="panel-body">
                    ...
                    <table class="table table-condensed  stafftable">
                        ...
                        <tr>
                            ...
                            <th>评价老师</th>
                            <td>
                                <input id="teachername" value="<?php echo $value['truename']?>" type="text"  class="form-control">
                                <input type="hidden" name="value[teacherid]" id="teacherid" value="<?php echo $value['teacherid']?>">

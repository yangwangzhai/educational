        ...
        <div style=" margin:20px; font-size:13px;">
            ...
            <div>
                    ...
                    <tbody><tr>
                        ...
                        <td width="30%">
                            <select name="value[contract_type]" class="form-control">
                                <?=getSelect(config_item('contract_type'),$value['contract_type'])?>
                            </select><br>

                            <input name="value[title]" value="<?php echo $value['title']?>" type="text" class="form-control">
                        </td>
                        ...
                        <td width="30%">
                            <div class="input-group">
                                <input  type="text" value="<?php echo $value['truename']?>" id="teachername" class="form-control" style=" background-color:#eee ">
             <span class="input-group-addon">
                <a href="javascript:void(0)" ><i class="glyphicon glyphicon-user"></i></a>
                            ...
                            <br>
                            <input name="value[uid]" value="<?php echo $value['uid']?>" id="teacherid" readonly type="text"  class="form-control" style=" background-color:#eee ">
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="value[contractno]" type="text" value="<?php echo $value['contractno']?>" class="form-control">
                        </td>

                        <th>经办人</th>
                        <td>
                            <input name="value[opusername]" type="text" value="<?php echo $value['opusername']?>" class="form-control">
                        </td>
                    ...
                    <tr>
                        ...
                        <th>合同生效开始时间 </th>
                        <td>
                            <input name="value[begintime]" value="<?php echo $value['begintime']?>" type="text" id="begintime" class="form-control">
                        ...
                        <td>
                            ...
                            <input name="value[endtime]" value="<?php echo $value['endtime']?>" type="text" id="endtime" class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <!-- add pic -->
            ...
            <div class="panel panel-default">
                <div class="panel-body text-center">
                    ...
                    <input type="submit" name="" value="更新合同"  class="btn btn-primary">

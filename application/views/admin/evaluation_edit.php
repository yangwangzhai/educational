                    ...
                    <div class="pull-center">
                        <table width="95%" class="table table-condensed  stafftable" >
                            ...
                            <tr>
                                <th>受评教师</th>
                                <td width="30%">
                                    <input value="<?=$value['truename']?>" id="teachername" type="text"  class="form-control">
                                    <input type="hidden" name="value[teacherid]" id="teacherid" value="<?=$value['teacherid']?>">
                                </td>
                                <th>孩子所在班级:</th>
                                <td width="30%">
                                    <input value="<?=$value['classname']?>" id="classname" onclick="show_classname()" type="text"  class="form-control">
                            ...
                            <tr>
                                <th>孩子姓名:</th>
                                <td width="30%">
                                    <input value="<?=$value['studentname']?>" id="studentname" type="text"  class="form-control">
                                    <input type="hidden" name="value[studentid]" id="studentid" value="<?=$value['studentid']?>">
                                </td>
                                <th>评价时间:</th>
                                <td width="30%">
                                    <input value="<?=$value['pubdate']?>" name="value[pubdate]" id="pubdate" type="text"  class="form-control">
                                </td>
                            </tr>
                            </tbody>
                        </table>   
                ...
                <div class="panel-body">
                        <table width="95%" class="table table-condensed  stafftable" >
                            ...
                            <tr>
                                ...
                                <td>8</td>
                                <td>5</td>
                                <td><input name="value[morality]" type="text" style="width:36px; text-align:center; font-size:18px; font-weight:bold;" value="<?=$value['morality']?>" maxlength="2" onChange="onNumCheck(this,'10');" onBlur="onNumCheck(this,'10');"></td>
                            </tr>
                            <tr>
                                <td>家访情况 <br>10分</td>
                                ...
                                <td>8</td>
                                <td>5</td>
                                <td><input name="value[visits]" type="text" style="width:36px; text-align:center; font-size:18px; font-weight:bold;" value="<?=$value['visits']?>" maxlength="2" onChange="onNumCheck(this,'10');" onBlur="onNumCheck(this,'10');"></td>
                            </tr>
                            <tr>
                                <td>课堂教学 <br>30分</td>
                                ...
                                <td>24</td>
                                <td>15</td>
                                <td><input name="value[chalkface]" type="text" style="width:36px; text-align:center; font-size:18px; font-weight:bold;" value="<?=$value['chalkface']?>" maxlength="2" onChange="onNumCheck(this,'30');" onBlur="onNumCheck(this,'30');"></td>
                            </tr>
                            <tr>
                                ...
                                <td>16</td>
                                <td>10</td>
                                <td><input name="value[correction]" type="text" style="width:36px; text-align:center; font-size:18px; font-weight:bold;" value="<?=$value['correction']?>" maxlength="2" onChange="onNumCheck(this,'20');" onBlur="onNumCheck(this,'20');"></td>
                            </tr>
                            <tr>
                                ...
                                <td>16</td>
                                <td>10</td>
                                <td><input name="value[habitual]" type="text" style="width:36px; text-align:center; font-size:18px; font-weight:bold;" value="<?=$value['habitual']?>" maxlength="2" onChange="onNumCheck(this,'20');" onBlur="onNumCheck(this,'20');"></td>
                            </tr>
                            <tr>
                                <td>教学效果 <br>10分</td>
                                ...
                                <td>8</td>
                                <td>5</td>
                                <td><input name="value[effect]" type="text" style="width:36px; text-align:center; font-size:18px; font-weight:bold;" value="<?=$value['effect']?>" maxlength="2" onChange="onNumCheck(this,'10');" onBlur="onNumCheck(this,'10');"></td>
                            </tr>
                            <tr>
                                <td>总计</td>
                                <td>计6项</td>

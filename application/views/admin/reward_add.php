                ...
                <div class="panel-body">
                    ...
                    <table class="table table-condensed  stafftable">
                        ...
                        <tbody><tr>
                            ...
                            <td width="30%">
                                <input value="" name="value[name]" type="text"  class="form-control">
                            </td>
                            <th></th>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="value[reward_type]" class="form-control"><?=getSelect($reward_type)?></select>
                            </td>
                            <th></th>
                            <td></td>
                        </tr>
                        <tr>
                            <th>奖励单位</th>
                            <td>
                                <input type="text" name="value[unit]" value="" class="form-control">
                            </td>
                            <th></th>
                            <td></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input name="value[grade]" type="text" class="form-control">
                            </td>
                            <th></th>
                            <td></td>
                        </tr>

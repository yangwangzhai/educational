    ...
    $(document).ready(function(){
        ...
        $('#chkShow').on('click',function(){
            if($('#chkShow').is(':checked')) {
                //获取选中的科目
                //location.href="index.php?d=admin&c=Test_score&m=statistic_analysis&check=true";
            }else{
                var subject=$('#sel_subject').val();
                location.href="index.php?d=admin&c=Test_score&m=statistic_analysis&check=false&subject="+subject;
            }
        });
...
<div style=" margin:20px; font-size:13px;">
    ...
    <div class="divDown">
        <div style="float: left;"><input type="checkbox" id="chkShow" checked="true" />显示人数</div>
        ...
        <table class="table" border="1" style="text-align:center">
            ...
            <?php foreach($list as $key=>$value):?>
                <tr>
                    ...
                    <td><?=$value['excellent_rate1']."%"."（".$value['excellent_rate1_num']."）";?></td>
                    <td><?=$value['excellent_rate2']."%"."（".$value['excellent_rate2_num']."）";?></td>
                    <td><?=$value['pass_rate']."%"."（".$value['pass_num']."）";?></td>
            ...
            <tr>
                ...
                <td><?=$grade['excellent_rate1_grade']."%"."（".$grade['excellent_rate1_num_grade']."）";?></td>
                <td><?=$grade['excellent_rate2_grade']."%"."（".$grade['excellent_rate2_num_grade']."）";?></td>
                <td><?=$grade['pass_rate_grade']."%"."（".$grade['pass_num_grade']."）";?></td>

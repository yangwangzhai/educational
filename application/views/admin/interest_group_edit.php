                ...
                <div class="panel-body">
                    ...
                    <table class="table table-condensed  stafftable">
                        ...
                        <tr>
                            ...
                            <td width="30%">
                                <input value="<?=$value['title']?>" name="value[title]" type="text"  class="form-control">
                            </td>
                            <th></th>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td width="30%">
                                ...
                                <input id="studentid" name="value[student]" type="hidden" value="<?=$value['studentid']?>" class="form-control">
                            </td>
                        </tr>
                        <tr>
                            <th>备注</th>

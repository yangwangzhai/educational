...
-------------------------------------------*/
    ...
    <script>
        $(document).ready(function(){
            ...
            // 弹出选择学生
            $("#ok").click(function(){
                dialog=dialog_url('index.php?d=admin&c=feedback&m=dialog&id=<?php echo $id?>&type=ok','核实通过');
            });
            $("#cancel").click(function(){
               dialog= dialog_url('index.php?d=admin&c=feedback&m=dialog&id=<?php echo $id?>&type=cancel','核实不通过');
            });
            $("#rectify").click(function(){
                dialog= dialog_url('index.php?d=admin&c=feedback&m=dialog&id=<?php echo $id?>&type=rectify','教师回复整改意见');
            });
            $("#verify").click(function(){
                dialog= dialog_url('index.php?d=admin&c=feedback&m=dialog&id=<?php echo $id?>&type=verify','整改审核');
            });
            $("#check").click(function(){
                dialog= dialog_url('index.php?d=admin&c=feedback&m=dialog&id=<?php echo $id?>&type=check','领导审阅');
            });

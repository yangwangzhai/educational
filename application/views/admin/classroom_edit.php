                ...
                <div class="panel-body">
                    ...
                    <table class="table table-condensed  stafftable">
                        ...
                        <tbody><tr>
                            ...
                            <td width="30%">
                                <input value="<?=$value['classname']?>" name="value[classname]" type="text"  class="form-control">
                                如：2015级1班
                            </td>
                            <th rowspan="2" width="20%">班级LOGO</th>
                            <td rowspan="2" width="30%">
                                <input name="value[logo]"  id="thumb" type="hidden" class="txt" value="<?=$value['logo']?>" >
                                <span id=""><a target="_blank" href="<?=$value['logo']?>"><img id="lbl_avtor" class="img-thumbnail" src="<?=small_name($value['logo'])?>"></a></span>

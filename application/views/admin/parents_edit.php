                ...
                <div class="panel-body">
                    ...
                    <table class="table table-condensed  stafftable">
                        ...
                        <tbody><tr>
                            ...
                            <th width="20%">班级名称</th>
                            <td width="30%">
                                <input id="classname" value="<?php echo $value['nickname']?>" onclick="show_classname()" type="text"  class="form-control">
                                <input type="hidden" name="value[classid]" id="classid" value="<?php echo $value['classid']?>">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="hidden" name="value[studentid]" id="studentid" value="<?php echo $value['student_id']?>">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select name="value[relatives]" class="form-control">
                                    <?=getSelect(config_item('relatives'),$value['relatives'])?></select>
                            </td>

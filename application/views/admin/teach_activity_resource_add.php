...
<body>
<form action="<?=$this->baseurl?>&m=teach_activity_resource_save" method="post" enctype="multipart/form-data">
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-condensed  stafftable">
                        ...
                        <tr>
                            ...
                            <td width="30%">
                                <input name="value[title]"   value="" class="form-control" />
                            </td>
                            <th ></th>
                            <td>
                            </td>
                        ...
                        <tr>
                            <th>发布人</th>
                            <td>
                                <input type="text" class="form-control" id="teachername" name="value[teacher]"
                                       value="" />
                                <input type="hidden" class="txt"  id="teacherid"
                                       value="" />
                            </td>
                            <th ></th>
                            <td>

    ...
    <div class="mainbox nomargin">
            <table width="768" border="1" cellpadding="0" cellspacing="0" class="opt">
                <tr height=50 align="center">   <!--2-->
                    <td width=130>姓&nbsp;&nbsp;名：</td>
                    <td width=181><?php echo $value['truename']?></td>
                ...
                <tr height=100 align="center">
                    ...
                    <td width=508 colspan="3">
                        <table width="99%" border="0" cellpadding="0" cellspacing="0" class="opt">
                            ...
                            <tr height=25 align="left"><td>4.	热爱学生，面向全体；师生关系融洽，一视同仁；无体罚与变相体罚（有此现象不得分）。</td></tr>
                        </table>
                    </td>
                    <td width=50 >
                ...
                <tr height=100 align="center">
                    ...
                    <td width=508 colspan="3">
                        <table width="99%" border="0" cellpadding="0" cellspacing="0" class="opt">
                            ...
                            <tr height=25 align="left"><td>2.	学生安全无事故（有流血、缝针或学生走失等事件不得分）。</td></tr>
                ...
                <tr height=100 align="center">
                    ...
                    <td width=508 colspan="3">
                        <table width="99%" border="0" cellpadding="0" cellspacing="0" class="opt">
                            ...
                            <tr height=25 align="left"><td>5.	活动质量高，教学环节紧凑，（学生无等待及“放羊式”现象）。</td></tr>
                ...
                <tr height=100 align="center">
                    ...
                    <td width=508 colspan="3">
                        <table width="99%" border="0" cellpadding="0" cellspacing="0" class="opt">
                            ...
                            <tr height=25 align="left"><td>2.	班内学生卫生习惯好。</td></tr>
                            <tr height=25 align="left"><td>3.	班内卫生、消毒好。（一处重复3次无分）</td></tr>
                            <tr height=25 align="left"><td>4.	关注学生冷暖，照顾好学生饮食，及时提醒学生喝水。</td></tr>
                        </table>
                    </td>
                    <td width=150>
                        <table width="99%" border="0" cellpadding="0" cellspacing="0" class="opt">

                    ...
                    <div class="panel-body">
                        <table class="table table-condensed  stafftable">
                            ...
                            <tr>
                                ...
                                <th>政治面貌</th>
                                <td>
                                    <input name="value[political_status]" type="text" class="form-control">
                                </td>
                            </tr>
                ...
                <div class="panel-body">
                    <table class="table table-condensed  stafftable">
                        ...
                        <tr>
                            <th>身份证号码</th>
                            <td>
                                <input name="value[idcard]" type="text" class="form-control">
                            </td>
                            <th>血型</th>
                            <td>
                                <input name="value[bloodtype]" type="text" class="form-control">
                            </td>
                        </tr>
                        <tr>
                            <th>父亲姓名</th>
                            <td>
                                <input name="value[father]" type="text" class="form-control">
                            </td>
                            <th>母亲姓名</th>
                            <td>
                                <input name="value[mother]" type="text" class="form-control">
                            </td>
                        </tr>
                        <tr>
                            <th>父工作单位</th>
                            <td>
                                <input name="value[f_workplace]" type="text" class="form-control">
                            </td>
                            <th>母工作单位</th>
                            <td>
                                <input name="value[m_workplace]" type="text" class="form-control">
                            </td>
                        ...
                        <tr>
                            <th>父亲电话</th>
                            <td>
                                <input name="value[f_tel]" type="text" class="form-control">
                            </td>
                            <th>母亲电话</th>
                            <td>
                                <input name="value[m_tel]" type="text" class="form-control">
                            </td>
                        </tr>
                        <tr>
                            <th>户口性质</th>
                        ...
                        <tr>
                            ...
                            <th>健康状况</th>
                            <td>
                                <input type="text" name="value[heath_status]" value="" class="form-control"/>
                            </td>
                        </tr>
                        </tbody>
                    </table>

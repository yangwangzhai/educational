                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table class="table table-condensed  stafftable">
                            ...
                            <tr>
                                <th>电话号码<font color="red">*</font></th>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <table id="" border="0" style="border-width:0px;width:200px;">
                                        <tbody><tr>
                                            <td><input id="a1" type="radio" name="value[middle_leader]" value="1" <?php if($value['middle_leader']==1) echo 'checked'?>><label for="a1">是</label></td>
                                            <td><input id="a0" type="radio" name="value[middle_leader]" value="0" <?php if($value['middle_leader']==0) echo 'checked'?>><label for="a0">否</label></td>
                                        </tr>
                                        </tbody></table>
                                </td>
                                <th>备课组长 </th>
                                <td>
                                    <table id="" border="0" style="border-width:0px;width:200px;">
                                        <tbody><tr>
                                            <td><input id="a1" type="radio" name="value[prepare_supervisor]" value="1" <?php if($value['prepare_supervisor']==1) echo 'checked'?>><label for="a1">是</label></td>
                                            <td><input id="a0" type="radio" name="value[prepare_supervisor]" value="0" <?php if($value['prepare_supervisor']==0) echo 'checked'?>><label for="a0">否</label></td>
                                        </tr>
                                        </tbody></table>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <table id="" border="0" style="border-width:0px;width:150px;">
                                        <tbody><tr>
                                            <td><input id="a1" type="radio" name="value[grade_supervisor]" value="1" <?php if($value['grade_supervisor']==1) echo 'checked'?>><label for="a1">是</label></td>
                                            <td><input id="a0" type="radio" name="value[grade_supervisor]" value="0" <?php if($value['grade_supervisor']==0) echo 'checked'?>><label for="a0">否</label></td>
                                        </tr>
                                        </tbody></table>
                                ...
                                <td>
                                    <table id="" border="0" style="border-width:0px;width:200px;">
                                        <tbody><tr>
                                            <td><input id="a1" type="radio" name="value[teach_supervisor]" value="1" <?php if($value['teach_supervisor']==1) echo 'checked'?>><label for="a1">是</label></td>
                                            <td><input id="a0" type="radio" name="value[teach_supervisor]" value="0" <?php if($value['teach_supervisor']==0) echo 'checked'?>><label for="a0">否</label></td>
                                        </tr>
                                        </tbody></table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="value[grade_group]" class="form-control">
                                        <option value="" <?php if($value['grade_group']=='') echo 'selected'?>>未选择</option>
                                        <option value="七年级" <?php if($value['grade_group']=='七年级') echo 'selected'?>>七年级</option>
                                        <option value="八年级" <?php if($value['grade_group']=='八年级') echo 'selected'?>>八年级</option>
                                        <option value="九年级" <?php if($value['grade_group']=='九年级') echo 'selected'?>>九年级</option>
                                    </select>
                                </td>
                                <th>性 别</th>
                                <td>

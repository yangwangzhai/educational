...
<body>
<form action="<?=$this->baseurl?>&m=knowledge_edit_save" method="post">
                ...
                <div class="panel-body">
                    <table class="table table-condensed  stafftable">
                        ...
                        <tr>
                            ...
                            <td width="30%">
                                <input name="value[knowledge_point]"   value="<?=$knowledge_point?>" class="form-control" />
                            </td>
                            <th ></th>
                            <td>
                            </td>
                            ...
                            <td>
                                <select name="value[subjectid]" class="form-control" id="selSubject">
                                    <?php foreach($subject as $value) : ?>
                                        <option value="<?php echo $value['id'];?>" <?php if($value['id']==$subject_select){echo "selected=selected";}?>>
                            ...
                            <td>
                                <select name="value[p_id]" class="form-control" id="selknowledge">
                                    ...
                                    <?php foreach($cates as $cate) : ?>
                                        <option value="<?php echo $cate['id'];?>" <?php if($cate['id']==$p_id){echo "selected=selected";}?>>

...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#again").on("click",function(){
            ...
            location.href="index.php?d=timetable&c=timetable&m=table_replace";
        });
    })
</script>
            ...
            <div id="xzgl">
                <div id="middle_auto">
                    ...
                    <div id="middle_auto_content">
                        排完啦，<a href="index.php?d=timetable&c=timetable&m=course_list">查看课表!!!</a>
                    </div>
                    <div id="middle_auto_again">
                        <!--<a href="index.php?d=admin&c=timetable&m=table_replace">再排一次</a>-->
                        <a href="javascript:void(0);" id="again">再排一次</a>
                    </div>
                </div>
            </div>
        </div>
